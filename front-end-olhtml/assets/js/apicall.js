								...
								<div class="col-lg-3 col-md-4 col-sm-6">
									<div class="single-featured-cars">
										...
										<div class="featured-cars-txt">
											<h2 id="${car._id}"><a href="detail.html?id=${car._id}">${car.name}</a></h2> 
											<h3>${car.price}$</h3> 
                                            <a href="detail.html?id=${car._id}" class="btn btn-info mt-2">View Details</a>
											<p>${car.description}</p>
										</div>
									</div>
								</div>`;
    ...
    const carHTML = `
            <div class="col-lg-3 col-md-4 col-sm-6">
              <div class="single-featured-cars">
                ...
                <div class="featured-cars-txt">
                  <h2 id="${car._id}">
                    <a href="/detail.html?id=${car._id}">${car.name}</a>
                  </h2>
                  <h3>${car.price}$</h3>
                  <a href="/detail.html?id=${car._id}" class="btn btn-info mt-2">View Details</a>
                  <p>${car.description}</p>
...
document
  .querySelector(".model-search-btn")
